        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-button">
                    <a href="{{ route('transaction.outgoing.create') }}" class="btn btn-primary">Tambah Surat</a>
                </div>
            ...
            <div class="section-body">
                ...
                <h2 class="section-title">Daftar Surat Keluar</h2>
                <p class="section-lead">
                    Anda dapat mengelola semua surat keluar, seperti mengedit, menghapus, dan melihat detailnya.
                </p>
                                ...
                                <div class="row">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end"
                                                                    ...
                                                                    <li>
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('transaction.outgoing.show', $letter->id) }}">
                                                                            <i class="fas fa-eye"></i> Lihat
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('transaction.outgoing.edit', $letter->id) }}">
                                                                            <i class="fas fa-edit"></i> Edit
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('transaction.outgoing.destroy', $letter->id) }}"
                                                                            method="POST"
                                    ...
                                    @empty
                                        <div class="col-12 text-center">
                                            <p class="text-muted">Tidak ada data surat keluar</p>
                                        </div>
                                    @endforelse
                                </div>
                            </div>
