        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card shadow-sm mb-4">
                    <form action="{{ route('transaction.incoming.update', $data->id) }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="from" value="{{ old('from', $data->from) }}"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="received_date"
                                        value="{{ old('received_date', $data->received_date ? \Carbon\Carbon::parse($data->received_date)->format('Y-m-d') : '') }}"
                                        class="form-control">
                                </div>
