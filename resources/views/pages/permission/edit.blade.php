                        ...
                        <form method="POST" action="{{ route('permissions.update', $permission->id) }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        <label>Sekolah</label>
                                        <p>{{ $permission->user->sekolah->nama ?? '-' }}</p>
                                    </div>
                                    <div class="form-group col-md-6 col-12">
                                        <label>Jurusan</label>
                                        <p>{{ $permission->user->jurusan->nama ?? '-' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <select name="is_approved" class="form-control" style="height: 40px;">
                                            <option value="1" {{ $permission->is_approval ? 'selected' : '' }}>Disetujui</option>
                                            <option value="0" {{ !$permission->is_approval ? 'selected' : '' }}>Tidak Disetujui</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
